...
public class ChronicleTradeMsg extends ChronicleMessage {
  ...
  public ChronicleTradeMsg(final Long ts, final LocalDateTime time, final String sym, final double bid, final double bsize, final double ask, final double assize, final String bex, final String aex){
    this.ts = ts;
    this.time = time;
    this.sym = sym;
    this.bid = bid;
