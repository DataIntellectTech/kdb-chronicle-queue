...
public class AdapterProperties {
    ...
    public AdapterProperties(Properties props){
        ...
        setAdapterWaitTimeWhenNoMsgs(Long.parseLong(props.getProperty("adapter.waitTime.whenNoMsgs","10000")));
        ...
        setKdbConnectionEnabled(Boolean.parseBoolean(props.getProperty("kdb.connection.enabled","true")));
